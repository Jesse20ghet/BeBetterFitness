...
public class DatabaseHelper extends SQLiteOpenHelper
{
    ...
    public void onCreate(SQLiteDatabase db)
    {
        try {
            ...
            db.execSQL("INSERT INTO Lift Values (1, 'Dumbbell Press', 'testDescrip')");
            db.execSQL("INSERT INTO Lift Values (2, 'Shoulder Fly', 'testDescrip')");
            db.execSQL("INSERT INTO Lift Values (3, 'Lat Pull', 'testDescrip')");
